...
/**
 * Enterprise domain processing engine for analytics - Component #2
 */
public class AnalyticsProcessor2 {
    ...
    public AnalyticsProcessor2() {
        this.id = UUID.randomUUID().toString();
        this.componentName = "AnalyticsProcessor2";
