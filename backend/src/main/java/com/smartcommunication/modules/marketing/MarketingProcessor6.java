...
/**
 * Enterprise domain processing engine for marketing - Component #6
 */
public class MarketingProcessor6 {
    ...
    public MarketingProcessor6() {
        this.id = UUID.randomUUID().toString();
        this.componentName = "MarketingProcessor6";
