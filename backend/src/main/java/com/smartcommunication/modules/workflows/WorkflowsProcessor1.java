...
/**
 * Enterprise domain processing engine for workflows - Component #1
 */
public class WorkflowsProcessor1 {
    ...
    public WorkflowsProcessor1() {
        this.id = UUID.randomUUID().toString();
        this.componentName = "WorkflowsProcessor1";
