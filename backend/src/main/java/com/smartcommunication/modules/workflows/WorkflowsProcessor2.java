...
/**
 * Enterprise domain processing engine for workflows - Component #2
 */
public class WorkflowsProcessor2 {
    ...
    public WorkflowsProcessor2() {
        this.id = UUID.randomUUID().toString();
        this.componentName = "WorkflowsProcessor2";
