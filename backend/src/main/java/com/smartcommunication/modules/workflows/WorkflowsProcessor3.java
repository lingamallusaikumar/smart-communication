...
/**
 * Enterprise domain processing engine for workflows - Component #3
 */
public class WorkflowsProcessor3 {
    ...
    public WorkflowsProcessor3() {
        this.id = UUID.randomUUID().toString();
        this.componentName = "WorkflowsProcessor3";
