...
/**
 * Enterprise domain processing engine for workflows - Component #6
 */
public class WorkflowsProcessor6 {
    ...
    public WorkflowsProcessor6() {
        this.id = UUID.randomUUID().toString();
        this.componentName = "WorkflowsProcessor6";
